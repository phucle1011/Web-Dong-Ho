...
export default function ProfileTab() {
  ...
  const fetchUser = async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:5000/users/${decoded.id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });

      const defaultAddress = response.data.data.addresses?.find(addr => addr.is_default === 1);
        ...
        <div className="flex-1">
          <div className="update-logo w-full mb-9">
            ...
            <p className="text-sm text-qgraytwo mb-5">
              Profile of at least Size <span className="ml-1 text-qblack">300x300</span>. Max 5mb.
            </p>
            <div className="flex xl:justify-center justify-start">
              <div className="relative">
                <div className="sm:w-[198px] sm:h-[198px] w-[199px] h-[199px] rounded-full overflow-hidden relative">
                  <img
                    src={profileImg || `${process.env.REACT_APP_PUBLIC_URL}/assets/images/edit-profileimg.jpg`}
                    alt="avatar"
