...
function AddBlog() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!title || !contentValue || !image || !userId || !blogCategoryId) {
      Swal.fire("Cảnh báo", "Vui lòng nhập đủ thông tin bắt buộc", "warning");
      return;
    }
            ...
            <div className="card-body p-4">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Nhập tiêu đề" required />
                </div>
                ...
                <div className="mb-3">
                  ...
                  <textarea className="form-control" rows="3" value={metaDescription} onChange={(e) => setMetaDescription(e.target.value)} placeholder="Nhập meta description (70-160 ký tự)" />
                </div>
