    ...
    const handleSearchChange = async (e) => {
        ...
        if (value.trim() !== '') {
            ...
            try {
                ...
                const res = await axios.get(`${Constants.DOMAIN_API}/admin/users/wishlist/search?userId=${userId}&searchTerm=${value}&page=${1}&limit=${limit}`);
                ...
                {loading ? (
                    ...
                    <>
                        <table className="w-full border-collapse border border-gray-300 mt-3">
                            ...
                            <tbody>
                                {(searchTerm.trim() === '' ? wishlistItems : searchResults).map((item, index) => (
