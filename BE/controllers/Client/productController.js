                ...
                include: [
                  {
                    ...
                    where: {
                      ...
                      status: "active", // ✅ Thêm điều kiện trạng thái
                    },
...
const variants = product.variants.map((variant) => {
  ...
  if (
    ...
    validPromo = promo; // ✅ Chỉ chấp nhận khuyến mãi hợp lệ
  ...
  return {
    ...variant.toJSON(),
    final_price: validPromo ? finalPrice : null, // ✅ Chỉ tính giá nếu khuyến mãi hợp lệ
